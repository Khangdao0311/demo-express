...
mongoose
  .connect("mongodb+srv://admin:pass@cluster.dyqbzq2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster")
  .then(() => console.log("Connect successful"))
  .catch((err) => console.log("Connect fail", err)).finally(() => console.log("done")
  )
